...
DEBUG = bool(config("DEBUG", default=1))
...
DATABASES = {
     'default': {
         ...
         'NAME': config('DATABASE_NAME', 'ewallet_db'),
         'USER': config('DATABASE_USERNAME', 'ewallet_user'),
         'PASSWORD': config('DATABASE_PASSWORD', 'ewallet_password'),
